    ...
    <div class="page page-center">
        <div class="container-tight py-4">
            <div class="empty">
                ...
                <p class="empty-title">Fitur Belum Tersedia</p>
                <p class="empty-subtitle text-secondary">
                    Pengembang tidak memiliki waktu yang cukup untuk membuat fitur keranjang.
                </p>
                <div class="empty-action">
                    <a href="../pages/beranda.php" class="btn btn-primary">
